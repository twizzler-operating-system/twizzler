...
use twizzler_rt_abi::bindings::{loaded_image, loaded_image_id, object_handle, dl_phdr_info};
...
impl MinimalRuntime {
    pub fn get_image_info(&self, id: loaded_image_id) -> Option<loaded_image> {
        ...
        Some(loaded_image {
           ...
           image_start: ((MAX_SIZE * crate::slot::RESERVED_IMAGE) + NULLPAGE_SIZE) as *const core::ffi::c_void,
