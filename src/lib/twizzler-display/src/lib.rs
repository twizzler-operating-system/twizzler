...
#[secgate::gatecall]
pub fn start_display() -> Result<(), TwzError> {}
#[secgate::gatecall]
pub fn create_window(winfo: WindowConfig) -> Result<(ObjID, u32), TwzError> {}
#[secgate::gatecall]
pub fn drop_window(handle: u32) -> Result<(), TwzError> {}
#[secgate::gatecall]
pub fn reconfigure_window(handle: u32, wconfig: WindowConfig) -> Result<(), TwzError> {}
#[secgate::gatecall]
pub fn get_window_config(handle: u32) -> Result<WindowConfig, TwzError> {}
#[secgate::gatecall]
